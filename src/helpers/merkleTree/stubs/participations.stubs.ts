...
export const ParticipationsStub = (): Array<any> => {
  // returning participations...
  return participations;
}

export const HardcodedParticipationsStub = (): Array<any> => {
  // returning participations...
  return hardcodedParticipations;
}